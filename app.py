...
def build_ui():
    ...
    with gr.Blocks(theme=theme, css=css, title="Qwen3-TTS Demo") as demo:
        ...
        <div style="text-align: center; margin: 20px auto; max-width: 800px;">
            ...
            <a href="https://www.youtube.com/@fm19.2?sub_confirmation=1" target="_blank" style="display: inline-block; padding: 10px 20px; background-color: #4285F4; color: white; border-radius: 6px; text-decoration: none; font-size: 1em;">🥳 More Colab</a>
        </div>""")
